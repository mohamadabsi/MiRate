...
namespace Framework.Core.Data
{
    ...
    public static class Extensions
    {
        ...
        public static void UseDatabase<T>(this IServiceCollection services, IConfiguration configuration, IHostEnvironment environment, string connection) where T : DbContext
        {
            var connectioon = configuration.GetConnectionString(connection);

            var builder = new SqlConnectionStringBuilder(connectioon);
            ...
            if (configuration.MockDataBase())
            {
                ...
                services.AddDbContextFactory<T>(b =>
                {
                    b.UseInMemoryDatabase(connectioon);
        ...
        public static void Migrate<T>(this IApplicationBuilder app,
