...
namespace Framework.Core.Extensions
{
    ...
    {
        public static string ToGregoreanDateString(this DateTime date, string dateFormat = "yyyy-MM-dd")
        {
        ...
        public static bool GreaterThanOrEqualTo(this DateTime date, DateTime compareToDate)
        {
            return date.Date >= compareToDate.Date;
        }
        public static bool LessThanOrEqualTo(this DateTime date, DateTime compareToDate)
        {
            return date.Date <= compareToDate.Date;
        }
        /// <summary>
        ...
        {
            return "";// new DateTimeHelper().GetCurrentUmAlQuraDateString(dateTime, dateFormat);
        }
        ...
        /// The <see cref="double"/>.
        /// </returns>
        public static double ToUnixLocalTimeStamp(this DateTime dateTime)
        {
            dateTime = dateTime.AddTicks(-(dateTime.Ticks % 10000000));
            return dateTime.Subtract(new DateTime(1970, 1, 1, 3, 0, 0, DateTimeKind.Local)).TotalMilliseconds;
        }
        ...
        public static DateTime AddBusinessDays(this DateTime current, int days, IEnumerable<DateTime> holidays = null)
        {
            ...
            for (var i = 0; i < unsignedDays; i++)
            {
                ...
                while (current.IsWeekend()|| (holidays != null && holidays.Contains(current.Date)));
            }
