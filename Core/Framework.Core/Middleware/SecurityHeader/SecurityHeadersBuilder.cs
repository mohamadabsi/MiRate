using System;
using Framework.Core.Middleware.SecurityHeader.Constants;

namespace Framework.Core.Middleware.SecurityHeader
{
    /// <summary>
    ...
    public class SecurityHeadersBuilder
    {
        ...
        /// </summary>
        public SecurityHeadersBuilder RemoveXPoweredByHeader()
        {
            _policy.RemoveHeaders.Add(XPoweredByConstants.Header);
            return this;
        }
        /// <summary>
