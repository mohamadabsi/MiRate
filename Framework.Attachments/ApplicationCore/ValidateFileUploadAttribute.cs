...
namespace Framework.Attachments
{
    ...
    public class ValidateFileUploadAttribute : ValidationAttribute
    {
        ...
        {
            //var attachmentTypeRepository = (IEFRepository<AttachmentType>)validationContext.GetService(typeof(IEFRepository<AttachmentType>));

            //var attType = attachmentTypeRepository.GetById(this.AttachmentTypeId);
            //if (attType == null)
            //{
            //    attType = attachmentTypeRepository.
            //         GetByQuery(at => at.Code == "DefaultAttachmentType")
            //         .FirstOrDefault();
            //}
